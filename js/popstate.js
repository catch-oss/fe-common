...
(function (root, factory) {
    ...
    return {
         ...
         * @return {void} [description]
         */
        bindPopState: function (conf) {

            conf = conf || {};
            conf.reloadOriginal = conf.reloadOriginal === undefined
                ? true
                : conf.reloadOriginal;
                    ...
                    setTimeout(function () {
                        ...
                        $(window)
                            ...
                            .on('popstate.fepopstate', function (e) {
                                ...
                                // default
                                var doReload = conf.reloadOriginal || originalLocation != window.location.pathname;
